...
void limits_init()
{
  ...
  int mode = eGPIO_EXTI_FALLING;
    ...
    mode = eGPIO_EXTI_RISING;
  }
  gpio_limit.init(LIMIT_PORT, LIMIT_MASK, mode, 0, 0); // nopull, lowspeed
}
...
{
  return  gpio_limit.read() ^= BITFLAG_INVERT_LIMIT_PINS;
}
